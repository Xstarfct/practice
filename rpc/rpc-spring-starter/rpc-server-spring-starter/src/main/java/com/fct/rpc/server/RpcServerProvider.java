...
import com.fct.rpc.server.config.RpcServerProperties;
import com.fct.rpc.server.store.LocalServerCache;
import com.fct.rpc.server.transport.RpcServer;
...
public class RpcServerProvider implements BeanPostProcessor, CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        log.info(" rpc server :{} start, appName :{} , port :{}", rpcServer, properties.getAppName(),
            properties.getPort());
