package com.fct.rpc.core.codec;

import com.fct.rpc.core.common.RpcRequest;
import com.fct.rpc.core.common.RpcResponse;
import com.fct.rpc.core.protocol.MessageHeader;
import com.fct.rpc.core.protocol.MessageProtocol;
import com.fct.rpc.core.protocol.MsgType;
import com.fct.rpc.core.protocol.ProtocolConstants;
import com.fct.rpc.core.serialization.RpcSerialization;
import com.fct.rpc.core.serialization.SerializationFactory;
...
public class RpcDecoder extends ByteToMessageDecoder {
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception {
        ...
        RpcSerialization rpcSerialization =
            SerializationFactory.getRpcSerialization(SerializationTypeEnum.parseByType(serializeType));
        switch (msgTypeEnum) {
            case REQUEST:
